"""Placeholder forex capability map. Forex remains scan-only."""
...
account_permission_requirements = {"FOREX_SPOT": ["regulated_forex_account", "margin_approval"]}
data_feed_requirements = {"FOREX_SPOT": ["forex_data_feed"]}
known_limitations = ["No regulated forex broker adapter is configured. Forex stays scan-only."]
